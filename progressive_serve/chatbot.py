...
sys.path.insert(0, "/workspace/7b_results/pruning/A")
...
def main():
    # 설정 경로
    model_path = "/workspace/7b_results/pruning/A"
    stage2_path = "/workspace/7b_results/pruning/checkpoints/stage2_layers_B.safetensors"
    stage3_path = "/workspace/7b_results/pruning/checkpoints/stage3_layers_C.safetensors"
